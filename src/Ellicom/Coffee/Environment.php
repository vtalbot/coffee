...
class Environment {
  ...
  /**
   * The CoffeeScript finder implementation.
   *
   ...
   * @var array
   */
  protected $extensions = array('coffee' => 'coffee');
  ...
  /**
   * Create a new CoffeeScript environment instance.
   *
  ...
  /**
   * Get the appropriate CoffeeScript engine for the given path.
   *
   * @param  string  $path
  ...
  /**
   * Get the extension used by the CoffeeScript file.
   *
   * @param  string  $path
   * @return string
   */
  ...
  /**
   * Add a location to the array of CoffeeScript locations.
   *
  ...
  /**
   * Register a valid CoffeeScript extension and its engine
   *
  ...
  /**
   * Get the CoffeeScript finder isntance.
   *
